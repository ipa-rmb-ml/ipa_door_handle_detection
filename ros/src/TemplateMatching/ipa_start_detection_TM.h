...
class StartHandleDetectionTM
{
public:

	StartHandleDetectionTM(ros::NodeHandle nh, sensor_msgs::PointCloud2::Ptr point_cloud_out_msg);
...
private:
	...
	double max_handle_lenght_;
	double max_handle_width_;
	double max_handle_height_;
